...
from .cerberus_custom_6 import CerberusCustomValidator6
from pytest import mark


@mark.test_integration
@patch('requests.Session')
class TestIntegration6(SetupTest):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.validator = CerberusCustomValidator6()
    ...
    def test_validate_payload_v6(self, mock_session):
        ...
        data = {"payload_version":6,"provider-fake_data1":"fake_value1", "fake_data2": 122}

        fake_item_request = sdk.request_catalog_item(
            "fake_catalog_item", **data)
        self.assertTrue(self.validator.catalog_item(fake_item_request.payload.customized))

        fake_action_request = sdk.request_resource_action(
        "fake_action_name", "fake_resource_id", **data)
        self.assertTrue(self.validator.resource_action(fake_action_request.payload.customized))
